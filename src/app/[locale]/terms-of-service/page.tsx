...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Solo Leveling: Karma Wiki",
    description: "Read the Terms of Service for Solo Leveling: Karma Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Solo Leveling: Karma Wiki",
      description: "Terms and conditions for using Solo Leveling: Karma Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Solo Leveling: Karma Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Solo Leveling: Karma Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Solo Leveling: Karma Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Solo Leveling: Karma Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Netmarble game "Solo Leveling: Karma". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and combat strategies</li>
              <li>Weapons and Blessings guides</li>
              <li>Character and Shadow Army information</li>
              <li>Boss encounter guides</li>
              <li>Story and lore coverage</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Solo Leveling: Karma Wiki is NOT affiliated with, endorsed by, or associated with
              Netmarble or the official developers of Solo Leveling: Karma. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Solo Leveling: Karma Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Netmarble and/or the developers of Solo Leveling: Karma. We use such
            ...
            <ul>
              ...
              <li><strong>Release Information:</strong> Game release dates, beta access, and game updates may change without notice. We are not responsible for availability or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SOLO LEVELING: KARMA WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including official game channels, social media platforms,
            ...
            <p>
              ...
              you and Solo Leveling: Karma Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@sololevelingkarma.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@sololevelingkarma.wiki</a>
            </p>
            <p>
